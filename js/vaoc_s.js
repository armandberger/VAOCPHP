 ...
 $(document).ready(function () {
    ...
    $.fn.chargeNomsCarte = function()
    {
        ...
        if ($(this).find("option").length < 10)
        {
            ...
            $.ajax({url: "./listenomscarte_s.php?partie=8"
                    ,success: function (data, statut) {
                        console.log(statut);
                        $(monselect).append(data);
                        console.log("fin append"+data);
                    }
    ...
    /* Fonction pour la sidebar des messages */
    /*
    $('#ouvrirmessages').on('click', function () {
        $('#SidebarMessages').css('width', '100%');
        $("#SidebarMessages").load("vaocqg_messages_s.php", {var1:x, var2:y, var3:z});
    });
...
function Trier()
{
    ...
    formPrincipale.action = "vaocqg_s.php#troupes";
...
function TailleLimite() {
    ...
    //if (typeof countedTextBox !== 'undefined')
...
{
    formPrincipale = document.getElementById("principal");
    formPrincipale.action = "vaochistorique_s.php";
    formPrincipale.target = "_self";
    formPrincipale.submit();
}
...
function callDonnerOrdreUnite(id_pion, id_element_unite)
{
    ...
    formPrincipale = document.getElementById("principal");
    formPrincipale.action = "vaocqg_s.php#tableau_pion" + id_pion;
    formPrincipale.target = "_self";
    formPrincipale.submit();
}
    ...
    $.ajax(
        {
            ...
            {
                //alert("error "+jqXHR.responseText+" "+ jqXHR.status +" " +textStatus+" " + errorThrown);
            }
        }
    );
}
...
function callAllerALapage(id_pion, i_page)
{
    ...
    if (id_pion < 0)
    {
        ...
        formPrincipale.action = "vaocqg_s.php#tableau_messages";
    }
    else
    {
        id = "pageNum_" + id_pion;
...
function callAllerALapageB(i_page)
{
    alert(" i_page=" + i_page);
    formPrincipale = document.getElementById("principal");
    formPrincipale.target = "_self";
    formPrincipale.action = "vaocbataille_s.php#tableau_messages";
...
{
    document.getElementById("principal").action="vaocqg_s.php";
...
$(function () {
    if ( $( "#editor" ).length ) { $('#editor').wysiwyg(); }
    if ( $( "img.lazy" ).length ) { $("img.lazy").Lazy(); }
});

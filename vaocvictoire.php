...
{
    document.getElementById("principal").action="index.php";
    document.getElementById("principal").target="_self";
    document.getElementById("principal").submit();
}

function callCinematique(id_pion)
{
    //alert(id_pion);
    document.getElementById("id_cinematique_pion").value=id_pion;
    document.getElementById("principal").action="vaoccinematique.php";
    document.getElementById("principal").target="_self";
    document.getElementById("principal").submit();
}
...
else
{
    ...
    {
        echo "<div class=\"row hidden-xs hidden-sm\"><div class=\"col-md-12 col-centered\">";
        if (3==$idVictoire)
        {
...
?>
    <div class="row">&nbsp;</div>
        <div class="row row-centered fond resultat">
            ...
            <div class="col-sm-12 hidden-xs col-centered">
            <?php
    ...
    <div class="row row-centered fond">
<?php
        //liste des nations
	...
	{
            $nb_lignes=0;
            $bilan[$row_nation->ID_NATION]="<div class=\"col-xs-12 col-lg-6 col-centered resultat col-lg-height\" id=\"joueur".$row_nation->ID_NATION."\">";
            $bilan[$row_nation->ID_NATION].="<div class=\"inside inside-full-height\"><div class=\"content\">";
            $bilan[$row_nation->ID_NATION].="<div class=\"row\"><div class=\"col-xs-12 col-centered\"><h1>".$row_nation->S_NOM."</h1></div></div>";
            ...
            if ($num_objectifs>0)
            {
                $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION].
                        "<div class=\"row\"><div class=\"col-xs-10 resultatentete\"><img alt=\"Objectifs\" title=\"Objectifs\" src='images/objectif_noir-26.png' /></div><div class=\"col-xs-2 resultatentete\"><img alt=\"Pts de victoire\" title=\"Pts de victoire\" src='images/points_de_victoire_noir-26.png' /></div></div>";
                while($row_objectif = mysql_fetch_object($res_objectifs))
                {
                    $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"row\"><div class=\"col-xs-10 \">".$row_objectif->S_NOM."</div>";
                    if ($row_nation->ID_NATION == $row_objectif->ID_NATION)
                    {
                        $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-2 \">".$row_objectif->I_VICTOIRE."</div></div>";
                        $totalVictoire[$row_nation->ID_NATION]= $totalVictoire[$row_nation->ID_NATION] + $row_objectif->I_VICTOIRE;  		
                    }
                    else
                    {
                        $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-2 \">0</div></div>";
                    }
                }
            }
            ...
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION].
                "<div class=\"row\">
                    <div class=\"col-xs-3 resultatentete\"><img alt=\"Nom\" title=\"Nom\" src='images/nom_noir-26.png' /></div>
                    <div class=\"col-xs-3 resultatentete\"><img alt=\"Commandant\" title=\"Commandant\" src='images/rang_noir-26.png' /></div>
                    <div class=\"col-xs-2 resultatentete\"><img alt=\"Effectif\" title=\"Effectif\" src='images/infanterie_noir-26.png' /></div>
                    <div class=\"col-xs-2 resultatentete\"><img alt=\"Initial\" title=\"Initial\" src='images/initial_noir-26.png' /></div>
                    <div class=\"col-xs-1 resultatentete\"><img alt=\"D&eacute;truite\" title=\"D&eacute;truite\" src='images/detruit_noir-26.png' /></div>
                    <div class=\"col-xs-1 resultatentete\"><img alt=\"Fuite\" title=\"Fuite\" src='images/deroute_noir-26.png' /></div>
                </div>";
            //liste des unites
            $requeteUnites="SELECT tab_vaoc_pion.S_NOM, ID_PION, ID_PION_PROPRIETAIRE, I_FATIGUE_REEL, I_MORAL_REEL, I_MORAL_MAX, S_POSITION, B_DETRUIT, B_FUITE_AU_COMBAT,";
            $requeteUnites.=" I_INFANTERIE_REEL, I_CAVALERIE_REEL, I_ARTILLERIE_REEL, I_INFANTERIE_INITIALE, I_CAVALERIE_INITIALE, I_ARTILLERIE_INITIALE";
	    	...
	    	//recherche du nom du leader
                ...
                if ($longueur>0)
                {
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                        "<div class=\"row\" style=\"border-color: blue; border-style: solid; border-width: 1px;\"><div class=\"col-xs-3 \">".$Noms[$row_nation->ID_NATION][$nb_lignes].
                ...
                {
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                        "<div class=\"row\" style=\"border-color: red; border-style: solid; border-width: 1px;\"><div class=\"col-xs-3 \">".$Noms[$row_nation->ID_NATION][$nb_lignes].
                        "</div>";
                }
                */
                /*
                $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                    ...
                    "<div class=\"col-xs-3 \">".$Noms[$row_nation->ID_NATION][$nb_lignes].
                    "</div>";
                */
                $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                ...
                {
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                    "<div class=\"col-xs-3 \">".$Chefs[$row_nation->ID_NATION][$nb_lignes].
                ...
                {
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                    "<div class=\"col-xs-3 \">".$Chefs[$row_nation->ID_NATION][$nb_lignes]."</div>";
                }
                 */
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes].
                    "<div class=\"col-xs-3 \">".$Chefs[$row_nation->ID_NATION][$nb_lignes]."</div>";
                ...
                {
                    //leader
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes]."<div class=\"col-xs-6\"><img alt=\"non\" src=\"images/transparent-26.png\" /></div>";
                }
                else
                {
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes]."<div class=\"col-xs-2 numerique\">".($row->I_INFANTERIE_REEL+$row->I_CAVALERIE_REEL)."</div>";
                    $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes]."<div class=\"col-xs-2 numerique\">".($row->I_INFANTERIE_INITIALE+$row->I_CAVALERIE_INITIALE)."</div>";
                    if (1==$row->B_DETRUIT)
                    {
                        $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes]."<div class=\"col-xs-1 \"><img alt=\"oui\" src=\"images/oui_noir-26.png\" /></div>";
                        $totalDetruit[$row_nation->ID_NATION]=$totalDetruit[$row_nation->ID_NATION]+1;
                    }
                    else
                    {
                        $bilanUnite[$row_nation->ID_NATION][$nb_lignes]=$bilanUnite[$row_nation->ID_NATION][$nb_lignes]."<div class=\"col-xs-1 \"><img alt=\"&nbsp;\" src=\"images/transparent-26.png\" /></div>";
                    }
...
*/
            ...
            for ($i = $nb_lignes; $i < $total_lignes; $i++) 
            {
                ...
                // $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"row\"><div class=\"col-xs-12 \"><img alt=\"&nbsp;\" src=\"images/transparent-26.png\"/></div></div>";
                // c'est pourquoi il faut recopier les lignes de l'autre nation mais en invisible pour qu'elles fassent la même hauteur
                $bilanUnite[$row_nation->ID_NATION][$i]="<div class=\"row victoire".$row_nation->ID_NATION."\"><div class=\"col-xs-12 \"><img alt=\"&nbsp;\" src=\"images/transparent-26.png\"/></div></div>";
            }
        }
	...
	while($row_nation = mysql_fetch_object($res_nation))
	{
            ...
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-6\">Total</div>";
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-2\">".$totalReel[$row_nation->ID_NATION]."</div>";
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-2\">".$totalInitial[$row_nation->ID_NATION]."</div>";
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-1\">".$totalDetruit[$row_nation->ID_NATION]."</div>";
            $bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"col-xs-1\">".$totalDemoralise[$row_nation->ID_NATION]."</div>";
	...
	while($row_nation = mysql_fetch_object($res_nation))
	{
		$bilan[$row_nation->ID_NATION]=$bilan[$row_nation->ID_NATION]."<div class=\"row\">
                    <div class=\"col-xs-12\"><h1>Points de victoire : ".$totalVictoire[$row_nation->ID_NATION]."</h1></div></div>";
...
<?php 
	if(FALSE==empty($id_login))
	{
            ...
            echo "<input name=\"retourQG\" class=\"btn btn-default\" id=\"btnRetourQG\" onclick=\"javascript:callRetourQG();\"
            type=\"image\" alt=\"retour au QG\" src=\"images/btnRetourQG2.png\" value=\"submit\" />";
	}
	else
	{
            //dans ce cas on peut revenir a l'accueil
            echo "<input name=\"Quitter\" class=\"btn btn-default\" id=\"btnQuitter\" onclick=\"javascript:callQuitter();\"
            type=\"image\" alt=\"retour a l'ecran general\" src=\"images/btnQuitter2.png\" value=\"submit\" />";
	}
        
        //compte-rendu
        echo "<input name=\"Compte-rendu\" class=\"btn btn-default\" id=\"btnCompteRendu\" onclick=\"javascript:window.open('".$row_repertoire->S_REPERTOIRE."_carte/compterendu.pdf');return false; \"
        type=\"image\" alt=\"compte-rendu\" src=\"images/compte_rendu2_on.png\" value=\"submit\" />";
?>            
<!--            <input name="id_historique" class="btn btn-default"
               id="btnHistorique" onclick="javascript:callHistorique();"
               type="image" alt="historique" src="images/btnHistorique2.png" value="submit" />     -->
        </div>
    </div>
</form>	
</div>

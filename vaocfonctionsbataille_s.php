...
//echo "ID_NATION".$ID_NATION;
    ...
    printf("<select id=\"%s\" name=\"%s\" class=\"custom-select\" onchange=\"javascript:callChangementEngagement();\" size=\"1\"", $id_chaine, $id_chaine);
    //echo "</span";
...
function AfficherBatailleHorizontale($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $ID_PION_ROLE, $I_TOUR, $ID_VICTOIRE)
{
    ...
    echo "<h2><strong>R&eacute;serves</strong></h2>";
    ...
    echo "</tr>";
    echo "<tr class='bataille' >";
    echo "<td class='batailleobstacle' style='width:100px; background-color: " . $row->S_COULEUROBSTACLE0 . "; ' title='" . $row->S_OBSTACLE0 . "'>";
    echo "&nbsp;</td>";
    echo "<td class='batailleobstacle' style='width:100px; background-color: " . $row->S_COULEUROBSTACLE1 . "; ' title='" . $row->S_OBSTACLE1 . "'>";
    echo "&nbsp;</td>";
    echo "<td class='batailleobstacle' style='width:100px; background-color: " . $row->S_COULEUROBSTACLE2 . "; ' title='" . $row->S_OBSTACLE2 . "'>";
    echo "&nbsp;</td>";
    echo "</tr>";
    echo "<tr class='bataille' >";
    echo "<td class='bataille' style='background-color: " . $row->S_COULEURTERRAIN3 . ";' title='" . $row->S_TERRAIN3 . "'>";
    echo "<span style='vertical-align:top;'>";
    echo "<span class='bordurecombat'>".$row->S_COMBAT_3."</span>";
    echo "</span>";
    echo "</td>";
    echo "<td class='bataille' style='background-color: " . $row->S_COULEURTERRAIN4 . ";' title='" . $row->S_TERRAIN4 . "'>";
    echo "<span style='vertical-align:top;'>";
    echo "<span class='bordurecombat'>".$row->S_COMBAT_4."</span>";
    echo "</span>";
    echo "</td>";
    echo "<td class='bataille' style='background-color: " . $row->S_COULEURTERRAIN5 . ";' title='" . $row->S_TERRAIN5 . "'>";
    echo "<span style='vertical-align:top;'>";
...
function AfficherBatailleVerticale($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $ID_PION_ROLE, $I_TOUR, $ID_VICTOIRE)
{
    ...
    echo "<tr class='bataille' >";
    echo "<td  class='bataille' rowspan='9'>";
    echo "<h2>R&eacute;serves</h2>";
    AfficherUnitesEnReserve($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_345, $ID_PION_ROLE, $I_TOUR, $ID_VICTOIRE);
    echo "</td>";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN3 . ";' title='" . $row->S_TERRAIN3 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_345, $ID_PION_ROLE, $row->ID_LEADER_345, $I_TOUR, 3, $ID_VICTOIRE);
    echo "</td>";
    echo "<td class='bataille' rowspan='3' style='width:100px; vertical-align:top; background-color: " . $row->S_COULEUROBSTACLE0 . ";' title='" . $row->S_OBSTACLE0 . "'>";
    echo "<img src=\"images/transparent.png\" width=20 height=1>"; //pour indiquer une taille minimale
    echo "</td>";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN0 . "; ' title='" . $row->S_TERRAIN0 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_012, $ID_PION_ROLE, $row->ID_LEADER_012, $I_TOUR, 0, $ID_VICTOIRE);
    echo "</td>";
    echo "<td class='bataille' rowspan='9'>";
    echo "<h2>R&eacute;serves</h2>";
    ...
    echo "<tr class='bataille' >";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN4 . "; ' title='" . $row->S_TERRAIN4 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_345, $ID_PION_ROLE, $row->ID_LEADER_345, $I_TOUR, 4, $ID_VICTOIRE);
    echo "</td>";
    echo "<td class='bataille' rowspan='3' style='width:100px; background-color: " . $row->S_COULEUROBSTACLE1 . "; ' title='" . $row->S_OBSTACLE1 . "'>";
    echo "</td>";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN1 . "; ' title='" . $row->S_TERRAIN1 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_012, $ID_PION_ROLE, $row->ID_LEADER_012, $I_TOUR, 1, $ID_VICTOIRE);
    echo "</td>";
    echo "</tr>";
    echo "<tr class='bataille' >";
    ...
    echo "<tr class='bataille' >";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN5 . "; ' title='" . $row->S_TERRAIN5 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_345, $ID_PION_ROLE, $row->ID_LEADER_345, $I_TOUR, 5, $ID_VICTOIRE);
    echo "</td>";
    echo "<td class='bataille' rowspan='3' style='width:100px; background-color: " . $row->S_COULEUROBSTACLE2 . ";' title='" . $row->S_OBSTACLE2 . "'>";
    echo "</td>";
    echo "<td class='bataille' style='vertical-align:top; background-color: " . $row->S_COULEURTERRAIN2 . "; ' title='" . $row->S_TERRAIN2 . "'>";
    AfficherEngagement($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $row->ID_NATION_012, $ID_PION_ROLE, $row->ID_LEADER_012, $I_TOUR, 2, $ID_VICTOIRE);
    echo "</td>";
    echo "</tr>";
    echo "<tr class='bataille' >";
...
function AfficherUnitesEngagesEnBataille($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $ID_NATION, $ID_PION_ROLE, $I_TOUR, $I_ZONE, $ID_VICTOIRE)
{
    ...
    else
    {
        while ($row = mysql_fetch_object($res_pions))
        {
            ...
            if ($ID_NATION_JOUEUR == $ID_NATION)
            {
                //si l'unite a donne un ordre de retrait a ce tour, il ne fait pas l'afficher
                $requete="SELECT tab_vaoc_ordre.ID_PION";
                $requete.=" FROM tab_vaoc_ordre";
                $requete.=" WHERE tab_vaoc_ordre.ID_PARTIE=".$ID_PARTIE;
                $requete.=" AND I_TOUR=".$I_TOUR;
...
function CompteUniteSurZone($db, $ID_PARTIE, $I_TOUR, $ID_BATAILLE, $I_ZONE_BATAILLE, $B_QG)
{
    ...
    $requete.=" AND tab_vaoc_pion.B_QG=".$B_QG; //uniquement les unites combattantes
    //echo $requete."<br/>";
    $res_pions = mysql_query($requete, $db);
...
function AfficherUnite($db, $ID_PARTIE, $ID_BATAILLE, $ID_NATION_JOUEUR, $ID_NATION, $ID_PION, $ID_PION_ROLE, $I_TOUR, $B_EN_DEFENSE, $B_ENGAGEE)
{
    ...
    //echo "ID_PION=".$ID_PION." row_nation_pion->ID_NATION=".$row_nation_pion->ID_NATION;
    ...
    if (0 == mysql_num_rows($res_ordre))
    {
        if (1 == $B_ENGAGEE)
        {
            ...
            else
            {
                ...
                echo "<button type=\"button\" value=\"submit\" alt=\"retait\" class=\"btn btn-dark bouton\" id=\"retait" . $ID_PION . "\" name=\"retait" . $ID_PION . "\" onclick=\"javascript:callRetrait(" . $ID_PION . ");\" >Retrait</button>";
                echo "</div>\r\n";
            }
            return;
        }
        ...
        if ($rowunite->B_QG > 0)
        {
            ...
            if ($nb_unites_gauche > 0 && $nb_unites_centre > 0 && 0 == $nb_unites_gauche_QG)
            {
                ...
                echo "<button type=\"button\" value=\"submit\" alt=\"gauche\" class=\"btn btn-dark bouton bataille\" id=\"gauche" . $ID_PION . "\" name=\"gauche" . $ID_PION . "\" onclick=\"javascript:callCombatPion(" . $ID_PION . ",'G');\" >Gauche</button>";
            }
            if (0 < $nb_unites_centre && 0 == $nb_unites_centre_QG)
            {
                ...
                echo "<button type=\"button\" value=\"submit\" alt=\"centre\" class=\"btn btn-dark bouton bataille\" id=\"centre" . $ID_PION . "\" name=\"centre" . $ID_PION . "\" onclick=\"javascript:callCombatPion(" . $ID_PION . ",'C');\" >Centre</button>";
            }
            if ($nb_unites_droite > 0 && $nb_unites_centre > 0 && 0 == $nb_unites_droite_QG)
            {
                ...
                echo "<button type=\"button\" value=\"submit\" alt=\"droite\" class=\"btn btn-dark bouton bataille\" id=\"droite" . $ID_PION . "\" name=\"droite" . $ID_PION . "\" onclick=\"javascript:callCombatPion(" . $ID_PION . ",'D');\" >Droite</button>";
            }
        }
        else
        {
            ...
            switch ($row->I_TYPE)
            {
                ...
                case ORDRE_COMBAT:
                    ...
                    else
                    {
                        ...
                        echo "<button type=\"button\" value=\"submit\" alt=\"annuler\" class=\"btn btn-dark bouton bataille\" id=\"annuler" . $ID_PION . "\" name=\"annuler" . $ID_PION . "\" onclick=\"javascript:callAnnulerPion(" . $ID_PION . ");\" >Annuler</button>";
                    }
                    $bOrdreCombat = true;
                    break;
                case ORDRE_RETRAIT:
                    ...
                    break;
                default:
                    //Cela peut etre un QG qui envoie un message
...
function AfficherCommandantEnChef($db, $ID_PARTIE, $ID_BATAILLE, $ID_LEADER, $ID_NATION_JOUEUR, $ID_NATION, $ID_PION_ROLE, $I_TOUR, $ID_VICTOIRE)
{
    ...
    if ($ID_LEADER >= 0)
    {
        ...
        //echo nomFichierImage($row_leader->S_NOM);
        echo "<img title=\"".$row_leader->S_NOM."\" alt=\"". nomFichierImage($row_leader->S_NOM) . ".jpg\" width=\"200\" src=\"images/" . nomFichierImage($row_leader->S_NOM) . ".jpg\" />";
        ...
        if (($ID_VICTOIRE < 0) && ($ID_NATION_JOUEUR == $ID_NATION) && ($ID_PION_ROLE == $ID_LEADER))
        {
            ...
            if (0 == mysql_num_rows($res_ordre_retraite))
            {
                ...
                echo "<br/><button type=\"button\" value=\"submit\" alt=\"retraite generale\" class=\"btn btn-dark bouton bataille\" id=\"retraiteGenerale" . $ID_LEADER . "\" name=\"retraiteGenerale" . $ID_LEADER . "\" onclick=\"javascript:callRetraiteGenerale(" . $ID_LEADER . ",1);\" >retraite generale</button>";
            }
            else
            {
                ...
                if ($I_TOUR == $row_retraite->I_TOUR)
                {
                    ...
                    echo "<br/><button type=\"button\" value=\"submit\" alt=\"annuler retraite generale\" class=\"btn btn-dark bouton bataille\" id=\"annulerRetraiteGenerale" . $ID_LEADER . "\" name=\"annulerRetraiteGenerale" . $ID_LEADER . "\" onclick=\"javascript:callRetraiteGenerale(" . $ID_LEADER . ",0);\" >annuler retraite generale</button>";
                }
                else
                {
                    //ben... rien !
    ...
    {
        echo "<img title=\"aucun\" alt=\"aucun_chef.png\" width=\"200\" src=\"images/aucun_chef.png\" />";
    }
}

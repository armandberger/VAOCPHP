...
//        else {alert ("e KO");}
   ...
   function callTrouver()
    {
   	document.getElementById("principal").action="vaoccarte_s.php";
   ...
   function callCarteZoom() {
        ...
        document.getElementById("principal").action = "vaoccartezoom_s.php";
...
<form method="post" id="principal" action="{$_SERVER['PHP_SELF']}" role="form">
    <?php 
    //champ caches
    ...
    <div class="row justify-content-center">
        <div class="col-xs-12 text-center">
            <div class="btn-group">
            <button alt="Rechercher" id='id_trouver' name='id_trouver' class="btn btn-info bouton" type='button' value='submit' onclick="javascript:callTrouver(); return false;">Trouver</button>&nbsp;
	<?php 
	...
	$id_chaine="id_destination";
        printf("<select id=\"%s\" name=\"%s\" size=1 class=\"custom-select\">",$id_chaine,$id_chaine);
        while($row = mysql_fetch_object($res_noms))
        {
            echo "<option";
...
<tr>
    ...
    <div class="row justify-content-center d-md-none">
        ...
        echo "<button alt=\"carte source\" id='id_chargement_carte' name='id_chargement_carte' class=\"btn btn-light bouton\" type='button' value='submit' onclick=\"javascript:window.open('".$repertoire."/".$row_campagne->S_CARTE."'); return false;\" >Carte</button>";
        ?>

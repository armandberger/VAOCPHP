...
<html>
	...
	function callVictoire(idpartie)
	{
		...
		document.getElementById("id_partie").value=idpartie;
	 	formPrincipale=document.getElementById("principal");
	 	formPrincipale.action="vaocvictoire_s.php";
	 	formPrincipale.target="_self";
	 	formPrincipale.submit();
 	}
...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xs-2 col-sm-2 col-md-1"><b>Nom</b></div>
            <div class="col-lg-1 d-none d-lg-block"><b>Scénario</b></div>
            <div class="col-md-2 col-lg-1 d-none d-md-block"><b>Début historique</b></div>
            <div class="col-md-2 col-lg-1 d-none d-md-block"><b>Fin historique</b></div>
            <div class="col-xs-2 col-sm-2 col-md-1"><b>Date</b></div>
            <div class="col-xs-1 col-sm-1 col-md-1"><b>Tour</b></div>
            <div class="col-lg-1 d-none d-lg-block"><b>Début réel</b></div>
            <div class="col-xs-2 col-sm-2 col-md-1"><b>Mise à jour</b></div>
            <div class="col-xs-2 col-sm-2 col-md-1"><b>Prochain tour dans</b></div>
            <div class="col-xs-2 col-sm-2 col-md-3"><b>En attente de</b></div>
        ...
        <?php
            ...
            while($row = mysql_fetch_object($res_partie))
            {
                ...
                echo "</div>";
                echo "<div class=\"col-lg-1 d-none d-lg-block\">".$row->NOM_JEU."</div>";
                echo "<div class=\"col-md-2 col-lg-1 d-none d-md-block\">".$row->DATE_INITIALE."</div>";
                echo "<div class=\"col-md-2 col-lg-1 d-none d-md-block\">".$row->DATE_FIN."</div>";
                echo "<div class=\"col-xs-2 col-sm-2 col-md-1\">".$row->DATE_TOUR."</div>";
                echo "<div class=\"col-xs-1 col-sm-1 col-md-1\">".$row->I_TOUR."</div>";
                echo "<div class=\"col-lg-1 d-none d-lg-block\">".$row->DATE_CREATION."</div>";
                echo "<div class=\"col-xs-2 col-sm-2 col-md-1\">".$row->DATE_MISEAJOUR."</div>";
                ...
                echo "<div class=\"col-xs-2 col-sm-2 col-md-3\">";
                $listeattente="";
                if ($row->ID_VICTOIRE>=0)
                {
                    $listeattente="&nbsp;";
            ...
            <input name="id_partie" id="id_partie" type="hidden" />
                ...
                if(FALSE==empty($id_login) && ""!=$id_login)
                {
                    ...
                    echo "<div class=\"row justify-content-center align-items-center\">";
                        echo "<div class=\"col-12 col-sm-3 col-md-3 \">";
                        ...
                        echo "<div class=\"col-12 col-sm-3 col-md-3 \">";
                        echo "<div class=\"form-group \" >";
                            echo "<button alt='deconnexion au service' id='id_deconnexion' name='id_deconnexion'  type='submit' class=\"btn btn-light bouton\" onclick=\"javascript:callDeconnexion();\">";
                        ...
                        echo "<div class=\"col-12 col-sm-3 col-md-3 \">";
                        echo "<div class=\"form-group \" >";
                            echo "<button alt=\"modifier son compte\" id='id_connexion_modification' name='id_connexion_modification'  type='button' value='submit' class=\"btn btn-light bouton\" onclick=\"javascript:callModifierConnexion();\"/>";
                            echo "Modifier son compte";
                            echo "</button>";
                        echo "</div>";
                        echo "</div>";
                        echo "<div class=\"col-12 col-sm-3 col-md-3 \">";
                        echo "<div class=\"form-group \" >";
                            echo "<button alt=\"Acces à mon QG\" id='id_connexion_mon_jeu' name='id_connexion_mon_jeu'  type='button' value='submit' class=\"btn btn-light bouton\" onclick=\"javascript:callQG();\"/>";
                            echo "Acc&egrave;s au QG";
                            echo "</button>";
                        echo "</div>";
                        echo "</div>";
                    echo "</div>";
                ...
                else
                {
                    ...
                    echo "<div class=\"row justify-content-center\">";
                        echo "<div class=\"col-12 \"><h2>Donnez le mot de passe à la sentinelle pour rejoindre votre QG.</h2></div>";
                    echo "</div>";

                    echo "<div class=\"row justify-content-center align-items-center\">";
                        echo "<div class=\"col-12 col-sm-5 col-md-5 \">";
                        ...
                        echo "<div class=\"col-12 col-sm-7 col-md-5 \">";
                        ...
                        echo "<div class=\"col-12 col-sm-12 col-md-2 align-items-center\">";
                            echo "<button name=\"id_connexion\" class=\"btn btn-light bouton\" ";
                            echo "id=\"id_connexion\" onclick=\"javascript:callConnexion();\"";
                            echo "type=\"button\" alt=\"connexion\" value=\"submit\" >Connexion</button>";
                        echo "</div>";
                    echo "</div>";
                }
                ?>
            <div class="row">
                <div class="col-12 text-center" style="padding-top:8px;">
                    <button name="id_aide" class="btn btn-info bouton"
                        ...
                        type="button" alt="aide" />Aide</button>
                </div>
            </div>
        </form>
    </div>
